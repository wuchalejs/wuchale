...
test('URL matcher', t => {
    ...
    t.assert.deepEqual(matcher(new URL('http://foo.js/es/')), {path: '/', locale: 'es', alternates: { en: '/en', es: '/es' }})
    t.assert.deepEqual(matcher(new URL('http://foo.js/es/ruta')), {path: '/path', locale: 'es', alternates: { en: '/en/path', es: '/es/ruta' }})
})
